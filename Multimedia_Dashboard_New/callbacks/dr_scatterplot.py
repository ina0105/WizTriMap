...
def scatterplot_is_zoomed(zoom_data, scatterplot_fig):
    ...
    print(f'{dashboard.capitalize()} {dataset} {method} Scatterplot is zoomed')
...
def euclidean_mnist_trimap_scatterplot_clicked_display(click_data, scatterplot_fig):
    ...
    with euclidean_image_lock:
        print('Euclidean MNIST TriMap Scatterplot is clicked')
        reconstructed_image_object = recon_image.display_euclidean_recon_image(click_data, 'MNIST', 'TriMap')
        original_image_object = original_image.display_euclidena_original_image(click_data, 'MNIST', scatterplot_fig)
        return reconstructed_image_object, original_image_object
...
def euclidean_fashion_mnist_trimap_scatterplot_clicked_display(click_data, scatterplot_fig):
    global euclidean_image_lock
    with euclidean_image_lock:
        print('Euclidean FashionMNIST TriMap Scatterplot is clicked')
        reconstructed_image_object = recon_image.display_euclidean_recon_image(click_data, 'FashionMNIST', 'TriMap')
        original_image_object = original_image.display_euclidena_original_image(click_data, 'FashionMNIST',
                                                                                scatterplot_fig)
        return reconstructed_image_object, original_image_object
...
def euclidean_cifar_trimap_scatterplot_clicked_display(click_data, scatterplot_fig):
    global euclidean_image_lock
    with euclidean_image_lock:
        print('Euclidean CIFAR TriMap Scatterplot is clicked')
        reconstructed_image_object = recon_image.display_euclidean_recon_image(click_data, 'CIFAR-100', 'TriMap')
        original_image_object = original_image.display_euclidena_original_image(click_data, 'CIFAR-100',
                                                                                scatterplot_fig)
        return reconstructed_image_object, original_image_object
...
def euclidean_mnist_trimap_scatterplot_empty_area_clicked_display(click_data):
    global euclidean_image_lock
    dataset = json.loads(click_data['graphId'])['dataset']
    click_data = {key: value for key, value in click_data.items() if key in ['x', 'y']}
    with euclidean_image_lock:
        print('Euclidean MNIST TriMap Scatterplot Empty Area is clicked')
...
def euclidean_fashion_mnist_trimap_scatterplot_empty_area_clicked_display(click_data):
    global euclidean_image_lock
    dataset = json.loads(click_data['graphId'])['dataset']
    click_data = {key: value for key, value in click_data.items() if key in ['x', 'y']}
    with euclidean_image_lock:
        print('Euclidean FashionMNIST TriMap Scatterplot Empty Area is clicked')
        reconstructed_image_object = recon_image.display_euclidean_recon_image(click_data, dataset, 'TriMap')
        original_image_object = get_blank_image_base64()
        return reconstructed_image_object, original_image_object
...
def euclidean_cifar_trimap_scatterplot_empty_area_clicked_display(click_data):
    global euclidean_image_lock
    dataset = json.loads(click_data['graphId'])['dataset']
    click_data = {key: value for key, value in click_data.items() if key in ['x', 'y']}
    with euclidean_image_lock:
        print('Euclidean CIFAR TriMap Scatterplot Empty Area is clicked')
        reconstructed_image_object = recon_image.display_euclidean_recon_image(click_data, dataset, 'TriMap')
        original_image_object = get_blank_image_base64()
        return reconstructed_image_object, original_image_object
...
def euclidean_mnist_umap_scatterplot_clicked_display(click_data, scatterplot_fig):
    global euclidean_image_lock
    with euclidean_image_lock:
        print('Euclidean MNIST UMAP Scatterplot is clicked')
...
def euclidean_fashion_mnist_umap_scatterplot_clicked_display(click_data, scatterplot_fig):
    global euclidean_image_lock
    with euclidean_image_lock:
        print('Euclidean FashionMNIST UMAP Scatterplot is clicked')
...
def euclidean_cifar_umap_scatterplot_clicked_display(click_data, scatterplot_fig):
    global euclidean_image_lock
    with euclidean_image_lock:
        print('Euclidean CIFAR UMAP Scatterplot is clicked')
...
def euclidean_mnist_umap_scatterplot_empty_area_clicked_display(click_data):
    global euclidean_image_lock
    dataset = json.loads(click_data['graphId'])['dataset']
    click_data = {key: value for key, value in click_data.items() if key in ['x', 'y']}
    with euclidean_image_lock:
        print('Euclidean MNIST UMAP Scatterplot Empty Area is clicked')
...
def euclidean_fashion_mnist_umap_scatterplot_empty_area_clicked_display(click_data):
    global euclidean_image_lock
    dataset = json.loads(click_data['graphId'])['dataset']
    click_data = {key: value for key, value in click_data.items() if key in ['x', 'y']}
    with euclidean_image_lock:
        print('Euclidean FashionMNIST UMAP Scatterplot Empty Area is clicked')
        reconstructed_image_object = recon_image.display_euclidean_recon_image(click_data, dataset, 'UMAP')
        original_image_object = get_blank_image_base64()
        return reconstructed_image_object, original_image_object
...
def euclidean_cifar_umap_scatterplot_empty_area_clicked_display(click_data):
    global euclidean_image_lock
    dataset = json.loads(click_data['graphId'])['dataset']
    click_data = {key: value for key, value in click_data.items() if key in ['x', 'y']}
    with euclidean_image_lock:
        print('Euclidean CIFAR UMAP Scatterplot Empty Area is clicked')
        reconstructed_image_object = recon_image.display_euclidean_recon_image(click_data, dataset, 'UMAP')
        original_image_object = get_blank_image_base64()
        return reconstructed_image_object, original_image_object
...
def euclidean_mnist_tsne_scatterplot_clicked_display(click_data, scatterplot_fig):
    global euclidean_image_lock
    with euclidean_image_lock:
        print('Euclidean MNIST T-SNE Scatterplot is clicked')
...
def euclidean_fashion_mnist_tsne_scatterplot_clicked_display(click_data, scatterplot_fig):
    global euclidean_image_lock
    with euclidean_image_lock:
        print('Euclidean FashionMNIST T-SNE Scatterplot is clicked')
...
def euclidean_cifar_tsne_scatterplot_clicked_display(click_data, scatterplot_fig):
    global euclidean_image_lock
    with euclidean_image_lock:
        print('Euclidean CIFAR T-SNE Scatterplot is clicked')
...
def euclidean_mnist_tsne_scatterplot_empty_area_clicked_display(click_data):
    global euclidean_image_lock
    dataset = json.loads(click_data['graphId'])['dataset']
    click_data = {key: value for key, value in click_data.items() if key in ['x', 'y']}
    with euclidean_image_lock:
        print('Euclidean MNIST T-SNE Scatterplot Empty Area is clicked')
...
def euclidean_fashion_mnist_tsne_scatterplot_empty_area_clicked_display(click_data):
    global euclidean_image_lock
    dataset = json.loads(click_data['graphId'])['dataset']
    click_data = {key: value for key, value in click_data.items() if key in ['x', 'y']}
    with euclidean_image_lock:
        print('Euclidean FashionMNIST T-SNE Scatterplot Empty Area is clicked')
        reconstructed_image_object = recon_image.display_euclidean_recon_image(click_data, dataset, 't_SNE')
        original_image_object = get_blank_image_base64()
        return reconstructed_image_object, original_image_object
...
def euclidean_cifar_tsne_scatterplot_empty_area_clicked_display(click_data):
    global euclidean_image_lock
    dataset = json.loads(click_data['graphId'])['dataset']
    click_data = {key: value for key, value in click_data.items() if key in ['x', 'y']}
    with euclidean_image_lock:
        print('Euclidean CIFAR T-SNE Scatterplot Empty Area is clicked')
        reconstructed_image_object = recon_image.display_euclidean_recon_image(click_data, dataset, 't_SNE')
        original_image_object = get_blank_image_base64()
        return reconstructed_image_object, original_image_object
...
def euclidean_mnist_pca_scatterplot_clicked_display(click_data, scatterplot_fig):
    global euclidean_image_lock
    with euclidean_image_lock:
        print('Euclidean MNIST PCA Scatterplot is clicked')
...
def euclidean_fashion_mnist_pca_scatterplot_clicked_display(click_data, scatterplot_fig):
    global euclidean_image_lock
    with euclidean_image_lock:
        print('Euclidean FashionMNIST PCA Scatterplot is clicked')
...
def euclidean_cifar_pca_scatterplot_clicked_display(click_data, scatterplot_fig):
    global euclidean_image_lock
    with euclidean_image_lock:
        print('Euclidean CIFAR PCA Scatterplot is clicked')
...
def euclidean_mnist_pca_scatterplot_empty_area_clicked_display(click_data):
    global euclidean_image_lock
    dataset = json.loads(click_data['graphId'])['dataset']
    click_data = {key: value for key, value in click_data.items() if key in ['x', 'y']}
    with euclidean_image_lock:
        print('Euclidean MNIST PCA Scatterplot Empty Area is clicked')
...
def euclidean_fashion_mnist_pca_scatterplot_empty_area_clicked_display(click_data):
    global euclidean_image_lock
    dataset = json.loads(click_data['graphId'])['dataset']
    click_data = {key: value for key, value in click_data.items() if key in ['x', 'y']}
    with euclidean_image_lock:
        print('Euclidean FashionMNIST PCA Scatterplot Empty Area is clicked')
        reconstructed_image_object = recon_image.display_euclidean_recon_image(click_data, dataset, 'PCA')
        original_image_object = get_blank_image_base64()
        return reconstructed_image_object, original_image_object
...
def euclidean_cifar_pca_scatterplot_empty_area_clicked_display(click_data):
    global euclidean_image_lock
    dataset = json.loads(click_data['graphId'])['dataset']
    click_data = {key: value for key, value in click_data.items() if key in ['x', 'y']}
    with euclidean_image_lock:
        print('Euclidean CIFAR PCA Scatterplot Empty Area is clicked')
        reconstructed_image_object = recon_image.display_euclidean_recon_image(click_data, dataset, 'PCA')
        original_image_object = get_blank_image_base64()
        return reconstructed_image_object, original_image_object
...
def multi_recon_mnist_trimap_scatterplot_clicked_display(click_data, scatterplot_fig):
    ...
    with multi_recon_image_lock:
        print('Multidimesional Reconstruction MNIST TriMap Scatterplot is clicked')
...
def multi_recon_fashion_mnist_trimap_scatterplot_clicked_display(click_data, scatterplot_fig):
    global multi_recon_image_lock
    with multi_recon_image_lock:
        print('Multidimesional Reconstruction FashionMNIST TriMap Scatterplot is clicked')
...
@app.callback(
    ...
    Output('multi-recon-image-7d', 'src', allow_duplicate=True),
    Output('original-image-multi-recon', 'src', allow_duplicate=True),
    Input({'dashboard': 'multi_recon', 'dataset': 'CIFAR-100', 'projection': 'TriMap', 'type': 'scatterplot'}, 'clickData'),
    State({'dashboard': 'multi_recon', 'dataset': 'CIFAR-100', 'projection': 'TriMap', 'type': 'scatterplot'}, 'figure'),
    prevent_initial_call=True
)
def multi_recon_cifar_trimap_scatterplot_clicked_display(click_data, scatterplot_fig):
    global multi_recon_image_lock
    with multi_recon_image_lock:
        print('Multidimesional Reconstruction CIFAR-100 TriMap Scatterplot is clicked')
...
def model_prog_trimap_scatterplot_clicked_display(click_data, scatterplot_fig, dataset, layer_number):
    ...
    with model_prog_image_lock:
        print(f'Model Progress {dataset} TriMap Scatterplot is clicked')
...
def model_prog_trimap_scatterplot_empty_area_clicked_display(click_data, dataset, layer_number):
    global model_prog_image_lock
    click_data = {key: value for key, value in click_data.items() if key in ['x', 'y']}
    with model_prog_image_lock:
        print(f'Model Progress {dataset} TriMap Scatterplot Empty Area is clicked')
        reconstructed_image_object = recon_image.display_cnn_layer_emb_recon_image(click_data, dataset, layer_number)
        original_image_object = get_blank_image_base64()
        return reconstructed_image_object, original_image_object
...
def model_prog_scatterplot_is_zoomed(zoom_data, scatterplot_fig, dataset):
    ...
    print(f'Model Progress {dataset} TriMap Scatterplot is zoomed')
...
def model_prog_trimap_radio_button(layer_number, dataset):
    ...
    with layer_number_change_lock:
        print('Model Progress Radio Button is clicked')
