...
def load_emmbeddings(dataset, method, layer):
    ...
    file_path = embeddings_dir / f"{dataset}_{method}_layer{layer}_embeddings.pt"
...
if __name__ == "__main__":
    ...
    parser.add_argument("--epochs-mnist", type=int, default=500, help="Epochs for MNIST and FashionMNIST models")
